...
public class ClerkDashboardController {
    ...
    // public String farmerClerk(Model model, @AuthenticationPrincipal MyUserDetails
    // employee) {

    // String loggedUserName = employee.getUsername();
    // Employees employees =
    // employeeService.getEmployeesByEmployeeName(loggedUserName);
    ...
    public String deleteFarmer(@PathVariable("id") Integer id, Model model, RedirectAttributes message,
            @AuthenticationPrincipal MyUserDetails employee) {
        String loggedUserName = employee.getUsername();
        Employees employees = employeeService.getEmployeesByEmployeeName(loggedUserName);
        Branches branch = employees.getBranch();
