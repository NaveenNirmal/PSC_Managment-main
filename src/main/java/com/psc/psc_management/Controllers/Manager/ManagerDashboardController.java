...
public class ManagerDashboardController {
    ...
    // public String managerDashboard(Model model, @AuthenticationPrincipal
    // MyUserDetails employee) {
    ...
    // Float usedBranchBudget = branch.getUsedBudget() == null ? 0 :
    // branch.getUsedBudget();
